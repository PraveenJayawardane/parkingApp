...
class ParkNowSetDurationScreen extends StatelessWidget {
  ParkNowSetDurationScreen({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            parkingController.showHowLongParking.value = '';
            parkingController.showTotalDuration.value = '';
            parkingController.isAvalabilityOfTimeSlot.value = false;
            Get.back();
          },
        ),
        title: const Text(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: LocationCodeView(
                        ...
                        parkName: parkingController
                                .parkingDetails.value.carParkName ??
                            '',
                        addressTow: parkingController
                                .parkingDetails.value.addressLineTwo ??
                            '',
                        addressOne: parkingController
                    ...
                    Obx(() {
                      return Visibility(
                        visible:
                            parkingController.isAvalabilityOfTimeSlot.value,
                        child: Column(
                          children: [
                            const SizedBox(
                              height: 10,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => AppLabel(
                                      text:
                                          '${parkingController.parkingFee.value.data?.carpark?.currency ?? ''}${parkingController.parkingFee.value.data?.price?.parkingFee?.toStringAsFixed(2) ?? ''}',
                                      fontSize: 14,
                                    ),
                                  )
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => AppLabel(
                                      text:
                                          '${parkingController.parkingFee.value.data?.carpark?.currency ?? ''}${parkingController.parkingFee.value.data?.price?.serviceFee?.toStringAsFixed(2) ?? ''}',
                                      fontSize: 14,
                                    ),
                                  ),
                                ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => AppLabel(
                                      text:
                                          '${parkingController.parkingFee.value.data?.carpark?.currency ?? ''}${parkingController.parkingFee.value.data?.price?.total?.toStringAsFixed(2) ?? ''}',
                                      fontSize: 14,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                ...
                                IconButton(
                                    ...
                                    onPressed: () {
                                      if (SharedPref.isGuestAccount()) {
                                        ...
                                        // ignore: prefer_is_empty
                                        if (userController.vehicles?.value?.data
                                                ?.length ==
                                            0) {
                                          Get.toNamed(Routes.ADD_VEHICLE_SCREEN,
                                              arguments: Get.previousRoute);
                      ...
                      child: InkWell(
                        onTap: () {
                          if (SharedPref.isGuestAccount()) {
                            ...
                            if (!parkingController
                                .isAvalabilityOfTimeSlot.value) {
                            } else {
                              // ignore: unnecessary_null_comparison
                              if (userController.selectedVehicle?.value?.vRN ==
                                  null) {
                                AppCustomToast.warningToast(
                                    'Please Add Vehicle To Continue');
                              } else {
                                if (parkingController.parkingFee.value.data
                                        ?.carpark?.currency ==
                                    null) {
                                  AppCustomToast.warningToast(
                                      'Please Select time to Calculate Bill');
                                } else {
                                  if (parkingController.parkingFee.value.data
                                          ?.carpark?.currency ==
                                      'LKR') {
                                    if (userController
                                      ...
                                      Get.toNamed(arguments: [
                                        ...
                                        '',
                                        '',
                                        parkingController.parkingFee.value.data
                                            ?.carpark?.currency
                                    ...
                                    if (userController
                                      ...
                                      Get.to(NmiPaymentScreen(
                                        price: parkingController.parkingFee
                                      ...
                                      children: [
                                        Obx(
                                          () => InkWell(
                                            ...
                                            child: userController.selectedCard
                                                        .value?.ccNumber ==
                                                    null
              ...
              child: Padding(
                ...
                child: Obx(() {
                  return CustomFilledButton(
                      btnController: userController
                                          .selectedVehicle?.value?.vRN !=
                                      null &&
                                  parkingController
                                      .isAvalabilityOfTimeSlot.value &&
                                  userController.selectedCard.value?.ccNumber !=
                                      null ||
                              parkingController.isIDontKnowParkingTime.value ==
                                  true
                          ? true
                          : false,
                      ...
                      clickEvent: () {
                        if (parkingController.isIDontKnowParkingTime.value) {
                          if (SharedPref.isGuestAccount()) {
                            ...
                            // print(userController.cardList.value.first.ccNumber);
                          ...
                          if (SharedPref.isGuestAccount()) {
                            ...
                            if (userController.selectedCard != null) {
                              ...
                              if (parkingController.parkingFee.value.data
                                ...
                                if (userController.cardList.isEmpty) {
                                  Get.to(NmiPaymentScreen(
                                    price: parkingController
