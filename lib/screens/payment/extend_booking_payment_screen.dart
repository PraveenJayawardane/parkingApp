...
class ExtendBookingPaymentScreen extends StatelessWidget {
  final String? bookingId;
  ExtendBookingPaymentScreen({super.key, required this.bookingId});
            ...
            CustomFilledButton(
                ...
                clickEvent: () {
                  if (formKey.currentState!.validate()) {
                    ParkingNowController().confirmExtendBooking(
