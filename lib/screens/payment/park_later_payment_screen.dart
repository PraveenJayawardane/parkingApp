...
class ParkLaterPaymentScreen extends StatelessWidget {
  ParkLaterPaymentScreen({super.key});

  final GlobalKey<FormState> paymentKey = GlobalKey<FormState>();
  var userController = Get.find<UserController>();
  var parkingLaterController = Get.find<ParkingLaterController>();
            ...
            CustomFilledButton(
                ...
                clickEvent: () {
                  if (formKey.currentState!.validate()) {
                    print(parkingLaterController.draftBookingId.value);
                    // bookingController.makeParkLaterBooking(
                    //    vaultId: userController.selectedCard.value!.customerVaultId!,
                    //     context: context,
                    //     parkingType: "parkLater",
                    //     bookingId: parkingLaterController.draftBookingId.value);
                  } else {
                    print('invalid!');
                  }
                })
